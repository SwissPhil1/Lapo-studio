...
export function BulkActionBar({ 
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50" role="toolbar" aria-label={t('common.accessibility.selectedPatients', { count: selectedCount })}>
      <div className="flex items-center gap-2 bg-primary text-primary-foreground px-5 py-3 rounded-full shadow-lg border border-primary/20">
        <div className="flex items-center gap-2 border-r border-primary-foreground/20 pr-4">
          ...
          <span className="font-medium" aria-live="polite">{selectedCount} patient{selectedCount > 1 ? 's' : ''}</span>
        </div>

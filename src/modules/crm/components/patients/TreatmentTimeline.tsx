      ...
      <div className="space-y-3">
        ...
        {nextScheduledDate && (
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <span className="text-sm text-foreground">
                {format(nextScheduledDate, 'MMM d, yyyy', { locale: dateLocale })}
              </span>
              <span className="text-xs text-primary ml-2">({t('patients:planned')})</span>
            </div>
          </div>
        )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <span className="text-sm text-warning">
                {format(nextDueDate, 'MMM d, yyyy', { locale: dateLocale })}
              </span>
        ...
        {pastAppointments.length === 0 && (
          <p className="text-sm text-muted-foreground">{t('patients:noCompletedTreatments')}</p>
        )}
      </div>
    </div>
  );
